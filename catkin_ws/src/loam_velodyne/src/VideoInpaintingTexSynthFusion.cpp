...
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/scaled_img.jpg",
//					scaled_img);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/sub_img.jpg",
//					sub_img);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/temp_img.jpg",
//					temp_img);
//
...
//					cv::Scalar(0, 255, 0));
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/det_img.jpg",
//					sub_img);
//			exit(0);
//		}
	}
...
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/scaled_img.jpg",
//					scaled_img);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/sub_img.jpg",
//					sub_img);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/temp_img.jpg",
//					temp_img);
//
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/inv_warped_patch.jpg",
//					inv_warped_patch);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/inv_warped_mask.jpg",
//					inv_warped_mask * 255);
//
//
//			cv::Mat disp_img;
...
//			cv::imwrite("/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/temp_img_2c_warped.jpg",
//								disp_img);
//
//			cv::imwrite("/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/warped_mask.jpg",
//					warped_mask*255);
//
//			cv::rectangle(sub_img,
//					cv::Rect(minLoc.x, minLoc.y, temp_img.cols, temp_img.rows),
//					cv::Scalar(0, 255, 0));
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/det_img.jpg",
//					sub_img);
//			exit(0);
//		}
	}
	...
	char outname[512];
	sprintf(outname, "/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/img_c%f_d%f_input.jpg", color_weight, depth_weight);
	...
	sprintf(outname, "/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/img_c%f_d%f_patchmatch.jpg", color_weight, depth_weight);
	cv::imwrite(outname, img);
	...
	sprintf(outname, "/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/img_c%f_d%f_bf.jpg", color_weight, depth_weight);
	cv::imwrite(outname, img);
	exit(1);
...
//	}
//	cv::imwrite(
//			"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/mask_before.png",
//			mask_before);
	/////////////////////////////////////////////////////////////////
...
//	}
//	cv::imwrite(
//			"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/mask_after.png",
//			mask_after);
//
//	exit(1);
	/////////////////////////////////////////////////////////////////
...
//	cv::imwrite(
//			"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/input_img.png",
//			input_img);
//	cv::imwrite(
//			"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/output_img.png",
//			output_img);
//	exit(1);
...
//					temp_img);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/warped_templ.jpg",
//					warped_templ);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/warped_mask.jpg",
//					warped_mask);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/scaled_img.jpg",
//					scaled_img);
...
//					scaled_img);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/inv_scaled_img.jpg",
//					inv_scaled_img);
//			cv::imwrite(
//					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/sub_img.jpg",
//					sub_img);
...
//	if (x == 178 && y == 217) {
//		char oname[512];
//		sprintf(oname, "/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/%f_temp_img.jpg", ave_pixel_diff);
//		cv::imwrite(oname, temp_img);
//
//		sprintf(oname, "/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/%f_scaled_img.jpg", ave_pixel_diff);
//		cv::imwrite(oname,	scaled_img);
//
//		sprintf(oname, "/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/%f_sub_img.jpg", ave_pixel_diff);
//		cv::imwrite(oname, sub_img);
//
//		sprintf(oname, "/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/%f_det_img.jpg", ave_pixel_diff);
//		cv::rectangle(sub_img,
//				cv::Rect(minLoc.x, minLoc.y, temp_img.cols, temp_img.rows),
//				cv::Scalar(0, 255, 0));
//		cv::imwrite(oname,	sub_img);
...
void InpaintingNNFUpdateWarpedTempl(cv::Mat &img, cv::Mat &proj_pts,
	...
	char oname[512];
	sprintf(oname,
			"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/input.jpg");
...
//		sprintf(oname,
//				"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/iter%04d.jpg",
//				iter);
//		cv::imwrite(oname, img);
...
//	cv::imwrite("/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/mask.jpg", mask);
//	cv::imwrite("/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/counting_mask.jpg", counting_mask);
...
//					char name[512];
//					sprintf(name,
//							"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/img%f_%d_%d_%d.jpg", ave_cost,
//							ix, iy, iz);
...
//			char oname100[512];
//			sprintf(oname100,
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/part%04d_scale%04d_upscale.jpg",
//					idx_part, iter);
...
//						cnt_sum.at<int>(v, u) = cnt_sum.at<int>(v, u) + 1;
			...
			//////////////////////////////////////////////////////////////////////////
//			sprintf(oname100,
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/part%04d_scale%04d_ptproj.jpg",
//					idx_part, iter);
//			cv::imwrite(oname100, ds_output_img);
			//////////////////////////////////////////////////////////////////////////
...
//		}
			...
			//////////////////////////////////////////////////////////////////////////
//			sprintf(oname100,
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/part%04d_scale%04d_ptfill.jpg",
//					idx_part, iter);
//			cv::imwrite(oname100, ds_output_img);
			//////////////////////////////////////////////////////////////////////////
...
//	cv::imwrite("/disk1/tmp/ds_output.jpg", ds_output_img);
			...
			char oname0[512];
			sprintf(oname0,
					"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/input_part%04d_scale%04d.jpg",
					idx_part, iter);
...
//										img_scales, img_rois, 1, ds_mask_dim, 1000.0 * (it + 1));
				char oname[512];
				sprintf(oname,
						"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/part%04d_scale%04d_iter%04d.jpg",
						idx_part, iter, it);
				cv::imwrite(oname, ds_output_img);
			}
			exit(1);
...
//					10);
			...
			//////////////////////////////////////////////////////////////////////////
//			sprintf(oname100,
//					"/home/miao/data/pandora_liang/set2/1534313648-1534313657_results/part%04d_scale%04d_voteave.jpg",
//					idx_part, iter);
//			cv::imwrite(oname100, ds_output_img);
			//////////////////////////////////////////////////////////////////////////
		}
...
//	}
//	imwrite(
//			"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/oimg_sparse.jpg",
//			output_img0);
	...
	//imwrite("/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/oimg_sparse.jpg", output_img);
...
//	cv::cvtColor(output_img, output_img, CV_GRAY2BGR);
//	applyColorMap(output_img, output_img, cv::COLORMAP_JET);
//	imwrite("/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/oimg_dense.jpg", output_img);
...
//	}
//	imwrite(
//			"/home/miao/data/pandora_liang/set2/1534313570-1534313581_results/oimg_dense.jpg",
//			output_img1);
//
//	exit(1);
...
int main(int argc, char **argv) {
	...
	sprintf(mask_path, "%s/%llu-%llu_mask/", argv[4],
			(long long) (min_time), (long long) (max_time));
	std::string mask_folder(mask_path); //= "/home/miao/data/pandora_liang/set2/mask/";
...
//    char flow_path[512];
//    sprintf(flow_path, "/home/miao/data/pandora_liang/set2/%llu-%llu_flow/",
//            (long long) (min_time), (long long) (max_time));
//    std::string flow_folder(flow_path); //= "/home/miao/data/pandora_liang/set2/mask/";
		...
		if (file_name.at(0) == 'b') {
			...
			if (min_time < lidar_end_time && lidar_end_time < max_time) {
				...
				if (rel_ptr != rel_poses.end() && glb_ptr != glb_poses.end()) {
					...
					//WriteToPLY(cloud, "/home/miao/Documents/motion_orig.ply");

...
int main(int argc, char **argv) {
	...
	if (argc<4) {
	        std::cout<<"exe <start_time> <end_time> <working_folder>"<<std::endl;
	        exit(0);
	    }
	    double min_time = std::stoll(argv[1]);
	    double max_time = std::stoll(argv[2]);
	    std::string working_folder =std::string(argv[3]);

...
if("TRUE" STREQUAL "TRUE")
  set(loam_velodyne_SOURCE_PREFIX ./src/loam_velodyne)
  set(loam_velodyne_DEVEL_PREFIX ./devel)
  ...
  set(loam_velodyne_INSTALL_PREFIX ./install)
...
if(NOT "./src/loam_velodyne/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'loam_velodyne' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in './src/loam_velodyne/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path ./devel/lib;./devel/lib;/opt/ros/kinetic/lib)
